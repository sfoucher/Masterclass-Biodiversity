...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/libra_rcnn_seed_100_train_subframes_A_B_E_K_WH_WB_NC.json',
...
load_from = '/content/drive/MyDrive/ARTICLE_TFE_10-12_2020/Models/Libra_RCNN/RUNS/SEED_100/epoch_30.pth'
resume_from = None
workflow = [('train', 1)]
